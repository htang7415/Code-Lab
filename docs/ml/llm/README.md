...
- Vote concentration (`modules/ml/llm/vote-concentration`)
- Top vote share (`modules/ml/llm/top-vote-share`)
- Runner-up vote share (`modules/ml/llm/runner-up-vote-share`)
- Answer uniqueness rate (`modules/ml/llm/answer-uniqueness-rate`)
- Answer repeat rate (`modules/ml/llm/answer-repeat-rate`)
- Answer mode count (`modules/ml/llm/answer-mode-count`)
- Answer frequency table (`modules/ml/llm/answer-frequency-table`)
- Vote frequency gap (`modules/ml/llm/vote-frequency-gap`)
- Vote imbalance (`modules/ml/llm/vote-imbalance`)
- Vote tail mass (`modules/ml/llm/vote-tail-mass`)
- Nonmajority vote share (`modules/ml/llm/nonmajority-vote-share`)
- Minority vote share (`modules/ml/llm/minority-vote-share`)
- Minority answer share (`modules/ml/llm/minority-answer-share`)
- Minority cluster count (`modules/ml/llm/minority-cluster-count`)
- Minority cluster share (`modules/ml/llm/minority-cluster-share`)
- Minority cluster mode (`modules/ml/llm/minority-cluster-mode`)
- Minority cluster entropy (`modules/ml/llm/minority-cluster-entropy`)
- Minority cluster top share (`modules/ml/llm/minority-cluster-top-share`)
- Minority cluster dominance (`modules/ml/llm/minority-cluster-dominance`)
- Minority cluster balance (`modules/ml/llm/minority-cluster-balance`)
- Minority cluster tail entropy (`modules/ml/llm/minority-cluster-tail-entropy`)
- Minority cluster residual mass (`modules/ml/llm/minority-cluster-residual-mass`)
- Minority cluster remainder ratio (`modules/ml/llm/minority-cluster-remainder-ratio`)
- Minority cluster tail balance (`modules/ml/llm/minority-cluster-tail-balance`)
- Minority cluster tail gap (`modules/ml/llm/minority-cluster-tail-gap`)
- Minority cluster tail share (`modules/ml/llm/minority-cluster-tail-share`)
- Minority cluster tail top share (`modules/ml/llm/minority-cluster-tail-top-share`)
- Minority cluster tail ratio (`modules/ml/llm/minority-cluster-tail-ratio`)
- Minority cluster tail concentration (`modules/ml/llm/minority-cluster-tail-concentration`)
- Minority cluster tail entropy gap (`modules/ml/llm/minority-cluster-tail-entropy-gap`)
